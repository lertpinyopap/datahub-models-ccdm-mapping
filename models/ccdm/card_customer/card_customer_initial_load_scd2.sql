{{
    config(
        enabled=var('enable_card_customer_initial_load', false),
...
with source_query as (
    ...
    from {{ ref('stg_v10_card_customer_initial') }}
),
...
typed_source_rows as (
    select
        ...
        source_query.CREATED_DATETIME as VALID_FROM_DATETIME,
    ...
    where customer_status.CUSTOMER_STATUS_KEY is not null
      ...
      and source_query.CREATED_DATETIME is not null
),
...
{{ v10_scd2(
    ...
    model_name='card_customer_initial_load_scd2'
) }}
